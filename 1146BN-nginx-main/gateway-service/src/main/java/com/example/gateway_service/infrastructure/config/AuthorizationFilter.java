...
public class AuthorizationFilter implements WebFilter {
    ...
    public static final Map<String, RoleType> routeRole = Map.of(
        "/api/bets", RoleType.USER,
        "/api/history", RoleType.USER,
        "/api/matches/admin", RoleType.RISK_MANAGER,
        "/api/tournaments/admin", RoleType.ADMIN,
        "/api/audit", RoleType.COMPLIANCE
    );
